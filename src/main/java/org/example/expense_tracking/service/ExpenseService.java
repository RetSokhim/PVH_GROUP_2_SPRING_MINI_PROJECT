...
public interface ExpenseService {
    ...
    ExpenseResponse insertNewExpense (ExpenseRequestDTO expenseRequestDTO) throws SearchNotFoundException, BadRequestException;
    ...
    ExpenseResponse updateExpenseById(UUID expenseId, ExpenseRequestDTO expenseRequestDTO, UUID userId) throws SearchNotFoundException, BadRequestException;
